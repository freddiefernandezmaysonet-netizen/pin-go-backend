...
import { buildCleaningStartSmsBody } from "./messaging.service";
...
test("cleaning start SMS fits one representative GSM-7 segment", () => {
...
test("maximum capped cleaning start values remain one GSM-7 segment", () => {
  const body = buildCleaningStartSmsBody({
