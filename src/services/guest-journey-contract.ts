...
export const GUEST_JOURNEY_FINANCIAL_OWNER_VERSION =
  "guest_journey_financial_owner_v1" as const;

export const GUEST_JOURNEY_PAYMENT_EVALUATION_HANDLER_CODE =
  "PAYMENT_EVALUATION_V1" as const;

export const GUEST_JOURNEY_COMPLIANCE_OWNER_VERSION =
  "guest_journey_compliance_owner_v1" as const;

export const GUEST_JOURNEY_REQUIREMENTS_SNAPSHOT_HANDLER_CODE =
  "REQUIREMENTS_SNAPSHOT_V1" as const;

export const GUEST_JOURNEY_GUEST_VERIFICATION_HANDLER_CODE =
  "GUEST_VERIFICATION_V1" as const;
