...
function canonicalizeJsonValue(
  ...
  if (ancestors.has(value)) {
    throw new Error("CHANNEX_ARI_CANONICAL_JSON_CIRCULAR_REFERENCE");
  }
  ...
  try {
    ...
    if (prototype !== Object.prototype && prototype !== null) {
      throw new Error("CHANNEX_ARI_CANONICAL_JSON_OBJECT_UNSUPPORTED");
    }
...
export function calculateChannexAriCanonicalJsonIntegrity(
  ...
  const serialized = stringifyChannexAriCanonicalJson(value);
