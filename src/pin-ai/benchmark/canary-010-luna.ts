...
async function main(): Promise<void> {
  ...
  if (process.env.PIN_AI_BENCHMARK_SCENARIO !== "010") throw new Error("PIN_AI_BENCHMARK_CANARY_SCENARIO_MUST_BE_010");
  ...
  const scenario = scenarios001To010.find((item) => item.id === "010");
  if (!scenario) throw new Error("PIN_AI_BENCHMARK_SCENARIO_010_MISSING");
