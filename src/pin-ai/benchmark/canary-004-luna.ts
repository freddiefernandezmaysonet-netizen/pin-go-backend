...
async function main(): Promise<void> {
  ...
  if (process.env.PIN_AI_BENCHMARK_SCENARIO !== "004") {
    throw new Error("PIN_AI_BENCHMARK_CANARY_SCENARIO_MUST_BE_004");
  }
  ...
  if (!scenario) {
    throw new Error("PIN_AI_BENCHMARK_SCENARIO_004_MISSING");
  }
