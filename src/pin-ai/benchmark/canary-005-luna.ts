...
async function main(): Promise<void> {
  ...
  if (process.env.PIN_AI_BENCHMARK_SCENARIO !== "005") {
    throw new Error("PIN_AI_BENCHMARK_CANARY_SCENARIO_MUST_BE_005");
  }
  ...
  const scenario = scenarios001To010.find((item) => item.id === "005");
  if (!scenario) {
    throw new Error("PIN_AI_BENCHMARK_SCENARIO_005_MISSING");
  }
  ...
  console.log("PIN_AI_BENCHMARK_CANARY_STARTED:005:gpt-5.6-luna");
