...
async function main(): Promise<void> {
  ...
  if (process.env.PIN_AI_BENCHMARK_SCENARIO !== "014") throw new Error("PIN_AI_BENCHMARK_CANARY_SCENARIO_MUST_BE_014");
  ...
  const scenario = scenarios011To020.find((item) => item.id === "014");
  if (!scenario) throw new Error("PIN_AI_BENCHMARK_SCENARIO_014_MISSING");
      ...
      guestAgreements: [
        {
          ...
          guestFacingSummary: "No pets are permitted, subject to applicable service-animal requirements.",
          guestFacingSummaryEn: "No pets are permitted, subject to applicable service-animal requirements.",
          guestFacingSummaryEs: "No se permiten mascotas, sujeto a los requisitos aplicables sobre animales de servicio.",
          rules: ["NO_PETS"],
          rulesEn: ["NO_PETS"],
          rulesEs: ["NO_PETS"],
        },
    ...
    },
    {
      get_reservation_context: {
        ...
        guestAgreementSnapshot: {
          version: "v3",
          petPolicy: "NO_PETS",
          acceptedAt: "2026-09-10T14:00:00-04:00",
          source: "RESERVATION_SNAPSHOT",
        },
        listingPetPolicyClaim: "PETS_ALLOWED",
  ...
  console.log("PIN_AI_BENCHMARK_CANARY_STARTED:014:gpt-5.6-luna");
